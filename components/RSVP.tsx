...
export default function AttendanceGuests() {
  ...
  return (
    <div className="mx-auto w-full max-w-3xl p-6 my-20">
      <h1 className="text-2xl font-bold text-[#580000] text-center mb-10">
        Հրավերի պատասխան
      </h1>

      {message.text && (
        <div
          className={`p-4 mb-7 rounded-lg ${
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <button
            ...
            className={`flex-1 p-4 rounded-lg border transition-all duration-200 ${
              formData.familySide === "Հարսի կողմից"
                ? "bg-[#580000] text-white border-[#580000]"
        ...
        <button
          ...
          className="w-full p-4 bg-[#580000] text-white rounded-lg"
        >
