...
export function TimeBox() {
  ...
  return (
    <motion.section
      {...anim}
      className=" mt-10 mb-15 FontSHK_Dzeragir flex flex-col gap-5 text-center  text-[#580000]  px-0 "
    >
      <div className="">
        {timeLeft.finished ? (
...
const TimeBoxItem = ({ label, value }: any) => (
  <div className=" text-3xl px-3 text-center ">
    <h2 className="mt-1 FontSHK_Dzeragir">{value}</h2>
    <p className="FontSHK_Dzeragir text-xl">{label}</p>
  </div>
);
